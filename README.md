...
We used these three new features along with `SODIUM` (which was largely uncorrelated with the other features) as the numerical features in the final model. We also used `INGREDIENTS`, unmodified from the baseline model.
